              ...
              <Card>
                ...
                >
                  <div
                    ref="chat"
                    slot="top"
                    class={this.getStyleName('msg-box')}
                    on-scroll={(e) => {
                  ...
                  >
                    {this.loading ? (
                      ...
                      <p class={this.getStyleName('msg-no-more')}>
                        没有更多消息了
                      </p>
                    ) : (
                      <a
                    ...
                    {this.chat.length === 0 ? (
                      ...
                      this.chat.map((ele) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              class={this.getStyleName('msg-send-status-box')}
                            >
                              {ele.sendStatus ===
                                myEnum.chatSendStatus.发送中 && (
                                <Icon
                                  type="ios-loading"
                                  size={18}
                                  class="loading-icon"
