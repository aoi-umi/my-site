...
export default class Print extends Base {
  ...
  async afterLoad() {
    ...
    if (!this.preview) {
      ...
      await this.updatePreview(this.printData[0])
    }
  }
      ...
      <Row gutter={10}>
        <Col sm={24} lg={6}>
          <Collapse value="0">
            ...
            <Panel>
              组件
              <div slot="content">{this.renderSideBar()}</div>
            </Panel>
          </Collapse>
        </Col>
        <Col sm={24} lg={18}>
      ...
      <div>
        <div class="hiprint-toolbar" style="margin-top:15px;">
          <ul>
              ...
              <a
                ...
                on-click={() => {
                  ...
                  if (!width || isNaN(width) || !height || isNaN(height)) {
                    return this.$Message.warning('请输入正确的宽高')
                  }
            ...
            <li>
              <a class="hiprint-toolbar-item" on-click={this.rotatePaper}>
                旋转
              </a>
            </li>
            <li>
              <a class="hiprint-toolbar-item" on-click={this.clearTemplate}>
                清空
              </a>
            </li>
    ...
    return (
      <div>
        ...
        <div class={this.getStyleName('preview-label')}>
          {this.printData.length > 1 &&
            this.printData.map((ele) => {
              return (
                <Button
                  on-click={() => {
