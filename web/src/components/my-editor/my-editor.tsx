  ...
  render() {
    ...
    return (
      <div>
        ...
        <quillEditor
          v-show={this.currType === ContentType.default}
          class={this.getStyleName('editor')}
          ref="quillEditor"
        ...
        <Row gutter={10} v-show={this.currType === ContentType.markdown}>
          <Col xs={12}>
            <div class={this.getStyleName('wrap')}>
              ...
              <Input
                type="textarea"
                class={this.getStyleName('md-editor')}
                v-model={this.markdownValue}
              />
            </div>
          </Col>
          <Col xs={12}>
            <div
              class={this.getStyleName('preview')}
              domPropsInnerHTML={this.markdownPreview}
            ></div>
          </Col>
        </Row>
      </div>
